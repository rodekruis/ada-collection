...
def add_parser(subparser, formatter_class):
    ...
    help = "Retrieve abd_model informations and MetaData"
    parser = subparser.add_parser("info", help=help, formatter_class=formatter_class, epilog=epilog)
    parser.add_argument("--version", action="store_true", help="if set, output abd_model version only")
...
def main(args):
    ...
    if not torch.cuda.device_count():
        print("========================================")
        print("WARNING: No GPU found, abd train won't be usable.")
        print("========================================")
    ...
    print("========================================")
    print("abd_model: " + abd.__version__)
    print("========================================")
    print("Linux   " + release)
